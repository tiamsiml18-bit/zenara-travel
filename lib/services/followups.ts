...
const FOLLOWUP_SELECT = `
  ...
  quotation:quotations ( id, quotation_number, pipeline_stage,
    current_version:quotation_versions!quotations_current_version_id_fkey ( destination, travel_start_date, travel_end_date, total_price, consultant_name_snapshot, hotel_name, valid_until ) ),
